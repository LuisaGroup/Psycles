...
[[nodiscard]] constexpr bool surface_value_family_has_direct_evaluator(
    ...
    return opcode == compiler::SurfaceSvmValueOpcode::convert ||
           ...
           opcode == compiler::SurfaceSvmValueOpcode::displacement ||
           opcode == compiler::SurfaceSvmValueOpcode::vector_displacement ||
           opcode == compiler::SurfaceSvmValueOpcode::light_falloff ||
