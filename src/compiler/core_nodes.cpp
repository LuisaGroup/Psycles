...
NodeRegistry make_core_node_registry() {
    ...
    static_cast<void>(registry.register_schema(NodeSchema{
        ...
        .inputs = {
            ...
            input("SheenWeight", SocketType::floating, SocketValue::floating(0.0f)),
            input("SheenRoughness", SocketType::floating, SocketValue::floating(0.5f)),
            input("SheenTint", SocketType::color, SocketValue::color({1.0f, 1.0f, 1.0f})),
            input("CoatWeight", SocketType::floating, SocketValue::floating(0.0f)),
            input("CoatRoughness", SocketType::floating, SocketValue::floating(0.03f)),
            input("CoatIOR", SocketType::floating, SocketValue::floating(1.5f)),
            input("CoatTint", SocketType::color, SocketValue::color({1.0f, 1.0f, 1.0f})),
            input("CoatNormal", SocketType::normal, SocketValue::normal({0.0f, 0.0f, 0.0f})),
