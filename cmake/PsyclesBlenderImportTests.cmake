add_executable(psycles_blender_missing_image_import_tests
    tests/test_blender_missing_image_import.cpp)
target_link_libraries(psycles_blender_missing_image_import_tests PRIVATE Psycles::luisa_runtime)
target_compile_features(psycles_blender_missing_image_import_tests PRIVATE cxx_std_20)
add_test(NAME psycles.blender_missing_image_import
    COMMAND psycles_blender_missing_image_import_tests)

add_executable(psycles_blender_camera_projection_import_tests
    tests/test_blender_camera_projection_import.cpp)
target_link_libraries(psycles_blender_camera_projection_import_tests PRIVATE Psycles::luisa_runtime)
target_compile_features(psycles_blender_camera_projection_import_tests PRIVATE cxx_std_20)
add_test(NAME psycles.blender_camera_projection_import
    COMMAND psycles_blender_camera_projection_import_tests)
...
add_executable(
    psycles_blender_normal_map_tangent_import_tests
    tests/test_blender_normal_map_tangent_import.cpp)
target_link_libraries(
    psycles_blender_normal_map_tangent_import_tests
    PRIVATE Psycles::luisa_runtime)
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_normal_map_tangent_import
    COMMAND psycles_blender_normal_map_tangent_import_tests)
...
add_executable(
    psycles_blender_ies_import_tests
    tests/test_blender_ies_import.cpp)
target_link_libraries(
    psycles_blender_ies_import_tests
    PRIVATE Psycles::luisa_runtime)
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_ies_import
    COMMAND psycles_blender_ies_import_tests)
...
add_executable(
    psycles_blender_voronoi_import_tests
    tests/test_blender_voronoi_import.cpp)
target_link_libraries(
    psycles_blender_voronoi_import_tests
    PRIVATE Psycles::luisa_runtime)
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_voronoi_import
    COMMAND psycles_blender_voronoi_import_tests)

add_executable(
    psycles_blender_gabor_import_tests
    tests/test_blender_gabor_import.cpp)
target_link_libraries(
    psycles_blender_gabor_import_tests
    PRIVATE Psycles::luisa_runtime)
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_gabor_import
    COMMAND psycles_blender_gabor_import_tests)
...
add_executable(
    psycles_blender_info_nodes_import_tests
    tests/test_blender_info_nodes_import.cpp)
target_link_libraries(
    psycles_blender_info_nodes_import_tests
    PRIVATE Psycles::luisa_runtime)
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_info_nodes_import
    COMMAND psycles_blender_info_nodes_import_tests)

add_executable(
    psycles_blender_normal_node_import_tests
    tests/test_blender_normal_node_import.cpp)
target_link_libraries(
    psycles_blender_normal_node_import_tests
    PRIVATE Psycles::luisa_runtime)
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_normal_node_import
    COMMAND psycles_blender_normal_node_import_tests)
...
target_compile_features(
    ...
    PRIVATE cxx_std_20)
add_test(
    NAME psycles.blender_ray_portal_import
    COMMAND psycles_blender_ray_portal_import_tests)
