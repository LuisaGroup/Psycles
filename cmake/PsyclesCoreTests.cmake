if(PSYCLES_BUILD_TESTS)
    ...
    if(TARGET psycles_luisa_runtime)
        ...
        add_executable(psycles_cycles_svm_closure_guards_tests
            tests/test_cycles_svm_closure_guards.cpp)
        target_link_libraries(psycles_cycles_svm_closure_guards_tests
            PRIVATE Psycles::luisa_runtime)
        target_include_directories(psycles_cycles_svm_closure_guards_tests
            PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
        target_compile_features(psycles_cycles_svm_closure_guards_tests PRIVATE cxx_std_20)
        ...
        add_executable(psycles_cycles_light_parameter_structure_tests
            tests/test_cycles_light_parameter_structure.cpp)
        target_link_libraries(psycles_cycles_light_parameter_structure_tests
            PRIVATE Psycles::luisa_runtime)
        target_compile_features(psycles_cycles_light_parameter_structure_tests PRIVATE cxx_std_20)
    ...
    if(Python3_Interpreter_FOUND)
        add_test(
            ...
            COMMAND "${Python3_EXECUTABLE}"
                "${CMAKE_CURRENT_SOURCE_DIR}/tests/test_cycles_ray_portal_fixture.py")
        add_test(
