...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_film_routing_tests
    SOURCE tests/test_luisa_cycles_film_routing.cpp
    TEST_STEM luisa_cycles_film_routing
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_film_routing_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_film_routing_tests PRIVATE
    PSYCLES_FILM_ROUTING_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_film_routing.txt")
if(TEST psycles.luisa_cycles_film_routing_vk)
    set_tests_properties(psycles.luisa_cycles_film_routing_vk PROPERTIES ENVIRONMENT
...
psycles_add_luisa_backend_test(
    ...
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_light_parameters_tests PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_light_parameters_tests PRIVATE
    PSYCLES_LIGHT_PARAMETERS="${PROJECT_SOURCE_DIR}/tests/data/cycles_light_parameters.txt"
    PSYCLES_LIGHT_PARAMETER_STATE="${PROJECT_SOURCE_DIR}/tests/data/cycles_light_parameters_state.txt"
    PSYCLES_LIGHT_PARAMETER_STATE_FTZ="${PROJECT_SOURCE_DIR}/tests/data/cycles_light_parameters_state_ftz.txt")
if(TEST psycles.luisa_cycles_light_parameters_vk)
    set_tests_properties(psycles.luisa_cycles_light_parameters_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_lamp_routing_tests
    SOURCE tests/test_luisa_cycles_lamp_routing.cpp
    TEST_STEM luisa_cycles_lamp_routing
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_lamp_routing_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_lamp_routing_tests PRIVATE
    PSYCLES_LAMP_ROUTING_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_lamp_routing.txt")
if(TEST psycles.luisa_cycles_lamp_routing_vk)
    set_tests_properties(psycles.luisa_cycles_lamp_routing_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_light_endpoints_tests
    SOURCE tests/test_luisa_light_endpoints.cpp
    TEST_STEM luisa_light_endpoints
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_light_endpoints_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_light_endpoints_tests PRIVATE
    PSYCLES_LIGHT_ENDPOINT_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_light_endpoints.txt")
if(TEST psycles.luisa_light_endpoints_vk)
    set_tests_properties(psycles.luisa_light_endpoints_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    ...
    LIBRARIES Psycles::luisa_runtime)
if(TEST psycles.luisa_volume_work_vk)
    set_tests_properties(psycles.luisa_volume_work_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_surface_nee_work_tests
    SOURCE tests/test_luisa_surface_nee_work.cpp
    TEST_STEM luisa_surface_nee_work
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_surface_nee_work_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
if(TEST psycles.luisa_surface_nee_work_vk)
    set_tests_properties(psycles.luisa_surface_nee_work_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_shared_closure_tests
    SOURCE tests/test_luisa_cycles_svm_shared_closure.cpp
    TEST_STEM luisa_cycles_svm_shared_closure
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_shared_closure_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_svm_shared_closure_tests PRIVATE
    PSYCLES_SHARED_CLOSURE_STATE_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_svm_shared_closure_state.txt")
if(TEST psycles.luisa_cycles_svm_shared_closure_vk)
    set_tests_properties(psycles.luisa_cycles_svm_shared_closure_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_missing_image_tests
    SOURCE tests/test_luisa_cycles_svm_missing_image.cpp
    TEST_STEM luisa_cycles_svm_missing_image
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_missing_image_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_svm_missing_image_tests PRIVATE
    PSYCLES_MISSING_IMAGE_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_svm_missing_image.txt")
if(TEST psycles.luisa_cycles_svm_missing_image_vk)
    set_tests_properties(psycles.luisa_cycles_svm_missing_image_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_holdout_state_tests
    SOURCE tests/test_luisa_cycles_holdout_state.cpp
    TEST_STEM luisa_cycles_holdout_state
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_holdout_state_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_holdout_state_tests PRIVATE
    PSYCLES_HOLDOUT_STATE_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_holdout_state.txt")
if(TEST psycles.luisa_cycles_holdout_state_vk)
    set_tests_properties(psycles.luisa_cycles_holdout_state_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_holdout_render_tests
    SOURCE tests/test_luisa_cycles_holdout_render.cpp
    TEST_STEM luisa_cycles_holdout_render
    LIBRARIES Psycles::luisa_runtime)
target_compile_definitions(psycles_luisa_cycles_holdout_render_tests PRIVATE
    PSYCLES_HOLDOUT_FIXTURES="${PROJECT_SOURCE_DIR}/tests/data/cycles_holdout")
if(TEST psycles.luisa_cycles_holdout_render_vk)
    set_tests_properties(psycles.luisa_cycles_holdout_render_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
psycles_add_luisa_backend_test(
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_volume_tests
    SOURCE tests/test_luisa_cycles_svm_volume.cpp
    TEST_STEM luisa_cycles_svm_volume
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_volume_tests
    PRIVATE "${PROJECT_SOURCE_DIR}/src/luisa")
target_compile_definitions(psycles_luisa_cycles_svm_volume_tests PRIVATE
    PSYCLES_VOLUME_SVM_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_svm_volume.txt")
if(TEST psycles.luisa_cycles_svm_volume_vk)
    set_tests_properties(psycles.luisa_cycles_svm_volume_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    ...
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_shadow_pipeline_tests
    PRIVATE "${PROJECT_SOURCE_DIR}/src/luisa")
target_compile_definitions(psycles_luisa_cycles_shadow_pipeline_tests PRIVATE
    PSYCLES_SHADOW_QUEUE_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_shadow_queue.txt")
if(TEST psycles.luisa_cycles_shadow_pipeline_vk)
    set_tests_properties(psycles.luisa_cycles_shadow_pipeline_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_shadow_queue_tests
    SOURCE tests/test_luisa_cycles_shadow_queue.cpp
    TEST_STEM luisa_cycles_shadow_queue
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_shadow_queue_tests
    PRIVATE "${PROJECT_SOURCE_DIR}/src/luisa")
target_compile_definitions(psycles_luisa_cycles_shadow_queue_tests PRIVATE
    PSYCLES_SHADOW_QUEUE_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_shadow_queue.txt")
if(TEST psycles.luisa_cycles_shadow_queue_vk)
    set_tests_properties(psycles.luisa_cycles_shadow_queue_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_native_shadow_tests
    SOURCE tests/test_luisa_cycles_svm_native_shadow.cpp
    TEST_STEM luisa_cycles_svm_native_shadow
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_native_shadow_tests
    PRIVATE "${PROJECT_SOURCE_DIR}/src/luisa")
target_compile_definitions(psycles_luisa_cycles_svm_native_shadow_tests PRIVATE
    PSYCLES_NATIVE_SHADOW_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_svm_native_shadow.txt")
if(TEST psycles.luisa_cycles_svm_native_shadow_vk)
    set_tests_properties(psycles.luisa_cycles_svm_native_shadow_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_closure_budget_tests
    SOURCE tests/test_luisa_cycles_svm_closure_budget.cpp
    TEST_STEM luisa_cycles_svm_closure_budget
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_closure_budget_tests
    PRIVATE "${PROJECT_SOURCE_DIR}/src/luisa")
if(TEST psycles.luisa_cycles_svm_closure_budget_vk)
    set_tests_properties(psycles.luisa_cycles_svm_closure_budget_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()

psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_stack_extent_tests
    SOURCE tests/test_luisa_cycles_svm_stack_extent.cpp
    TEST_STEM luisa_cycles_svm_stack_extent
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_stack_extent_tests
    PRIVATE "${PROJECT_SOURCE_DIR}/src/luisa")
if(TEST psycles.luisa_cycles_svm_stack_extent_vk)
    set_tests_properties(psycles.luisa_cycles_svm_stack_extent_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_scene_admission_tests
    SOURCE tests/test_luisa_cycles_svm_scene_admission.cpp
    TEST_STEM luisa_cycles_svm_scene_admission
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_scene_admission_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
if(TEST psycles.luisa_cycles_svm_scene_admission_vk)
    set_tests_properties(psycles.luisa_cycles_svm_scene_admission_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_camera_ray_tests
    SOURCE tests/test_luisa_cycles_camera_ray.cpp
    TEST_STEM luisa_cycles_camera_ray
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_camera_ray_tests PRIVATE
    "${PROJECT_SOURCE_DIR}/src/luisa")
target_compile_definitions(psycles_luisa_cycles_camera_ray_tests PRIVATE
    PSYCLES_CAMERA_RAY_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_camera_ray.txt")
if(TEST psycles.luisa_cycles_camera_ray_vk)
    set_tests_properties(psycles.luisa_cycles_camera_ray_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_voronoi_octave_tests
    SOURCE tests/test_luisa_cycles_svm_voronoi_octave.cpp
    TEST_STEM luisa_cycles_svm_voronoi_octave
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_voronoi_octave_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_svm_voronoi_octave_tests PRIVATE
    PSYCLES_VORONOI_OCTAVE_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_svm_voronoi_octave_state.txt")
if(TEST psycles.luisa_cycles_svm_voronoi_octave_vk)
    set_tests_properties(psycles.luisa_cycles_svm_voronoi_octave_vk
        PROPERTIES ENVIRONMENT
            "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
...
psycles_add_luisa_backend_test(
    TARGET psycles_luisa_cycles_svm_closure_guards_tests
    SOURCE tests/test_luisa_cycles_svm_closure_guards.cpp
    TEST_STEM luisa_cycles_svm_closure_guards
    LIBRARIES Psycles::luisa_runtime)
target_include_directories(psycles_luisa_cycles_svm_closure_guards_tests
    PRIVATE ${PROJECT_SOURCE_DIR}/src/luisa)
target_compile_definitions(psycles_luisa_cycles_svm_closure_guards_tests PRIVATE
    PSYCLES_CLOSURE_GUARDS_ORACLE="${PROJECT_SOURCE_DIR}/tests/data/cycles_svm_closure_guards_state.txt")
if(TEST psycles.luisa_cycles_svm_closure_guards_vk)
    set_tests_properties(psycles.luisa_cycles_svm_closure_guards_vk PROPERTIES ENVIRONMENT
        "LUISA_VULKAN_USE_XIR=1;LUISA_VULKAN_REQUIRE_NATIVE_XIR_SPIRV=1;LUISA_VULKAN_DISABLE_DXC=1")
endif()
