...
_PROBES: dict[str, Callable[[Any], None]] = {
    ...
    "light_falloff_matrix": camera_inputs._light_falloff_matrix,
    "info_nodes_matrix": camera_inputs._info_nodes_matrix,
    ...
    "normal_node_matrix": normal_inputs._normal_node_matrix,
    ...
    "sheen_bsdf_matrix": sheen_closures._sheen_bsdf_matrix,
