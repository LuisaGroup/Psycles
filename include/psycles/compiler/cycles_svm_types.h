...
enum PathRayVisibilityFlag : uint {
  PATH_RAY_VISIBILITY_NONE = 0u,
...
inline constexpr uint LIGHT_LINK_SET_MAX = 64u;
inline constexpr std::uint64_t LIGHT_LINK_MASK_ALL =
    ~std::uint64_t{0u};
