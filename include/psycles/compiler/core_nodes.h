...
inline constexpr auto normal = "psycles.normal";
...
inline constexpr auto vector_curve = "psycles.vector.curve";
inline constexpr auto float_curve = "psycles.value.float_curve";
